...
export const events: Event[] = [
  {
    ...
    description:
      "Venta de ropa, muebles, libros y artículos para el hogar en muy buen estado.",
  },
  {
    id: "2",
    ...
    description:
      "Garage sale familiar con juguetes, electrodomésticos, ropa y decoración.",
  },
  {
    id: "3",
    ...
    description:
      "Artículos usados y nuevos a precios especiales durante toda la mañana.",
  },
  {
    id: "4",
    ...
    description:
      "Kermesse familiar con comida típica, juegos, música y actividades para niños.",
  },
  {
    id: "5",
    ...
    description:
      "Una jornada familiar con gastronomía, juegos, rifas y presentaciones musicales.",
  },
  {
    id: "6",
    ...
    description:
      "Evento comunitario con comida, artesanías y actividades para toda la familia.",
  },
  {
    id: "7",
    ...
    description:
      "Feria con emprendimientos locales de gastronomía, ropa, accesorios y productos artesanales.",
  },
  {
    id: "8",
    ...
    description:
      "Exposición y venta de artesanías, productos locales y gastronomía tradicional.",
  },
  {
    id: "9",
    ...
    description:
      "Feria dedicada a la gastronomía local con restaurantes, chefs y pequeños productores.",
  },
];
